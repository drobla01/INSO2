...
public class SocialController {
	...
	public String addFriend(@RequestParam(name = "id", required = true) Integer id, Model model) {
		return "/user/social"; //return "forward:/user/social?id="+id; esta genera el bucle infinito
	}
